...
class PluginBuilder {
    ...
    constructor(version = null) {
        ...
        this.directories = ['inc', 'build', 'src', 'languages', 'assets'];
    ...
    async cleanDsStoreFiles() {
        const dsStoreFiles = ['build/.DS_Store', '.DS_Store', 'src/.DS_Store', 'languages/.DS_Store', 'assets/.DS_Store', 'inc/.DS_Store'];
...
async function main() {
    ...
    setTimeout(() => {
        ...
        exec('open ./dist', (error, stdout, stderr) => {
            /** I culd handle any error here  */
        });
    }, 5000);
}
